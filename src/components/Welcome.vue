<template>
    <div>
        ...
        <div class="portfolio-modal modal fade" ref="setPriceModal" id="setPriceModal" tabindex="-1" role="dialog" aria-hidden="true">
         ...
         <!-- Type code modal popup-->
        <div class="portfolio-modal modal fade" id="createCodeModal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog mx-auto modal-dialog-centered">
                <div class="modal-content">
                    <div class="container">
                        <div class="row justify-content-center">
...
export default {
    ...
    methods : {
        ...
        async copyText() {
            /* Get the text field */            
            let copyText = document.getElementById("randomCodeInput");
